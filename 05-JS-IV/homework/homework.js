...
function agregarPropiedad(objeto, property) {
  ...
  return objeto;
  //esta funcion lo que hace es agregarle una propiedad a un objeto creado en otro scope, y lo setea en null
}
...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  //se usa corchetes porque estoy usando una variable, en vez de acceder al valor real del objeto a eliminar??????
  return objeto;
}
...
function tieneEmail(usuario) {
  ...
  // se declara como string porque no es un valor local???
...
function actualizarPassword(usuario, nuevaPassword) {
  ...
  //verificar como se accede a la propiedad password
