...
//persona sin mayuscula es la variable en la que guardo la informacion que me crea el constructor, 
//el cual si lleva mayuscula
  const persona = new Persona('juan','perez',22,'saavera332');
  return persona;
}
